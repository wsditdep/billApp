            ...
            <>
                <div className="billing_childs">
                    ...
                    <div className="app-heading">
                        <h3>PREVIEW - <span>Mobile 83</span></h3>
                    ...
                    <div className="mobile-view-wrapper go_with_code" style={{ scale: imageDimension + "%" }}>
...
export default EightyThreePage;